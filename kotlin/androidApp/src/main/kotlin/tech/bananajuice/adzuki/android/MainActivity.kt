        ...
        kotlinx.coroutines.withContext(Dispatchers.IO) {
            try {
                ...
                kotlinx.coroutines.withContext(Dispatchers.Main) {
                    Toast.makeText(context, "An error occurred while reading balances.", Toast.LENGTH_SHORT).show()
                }
                balances = emptyList()
            }
        }
                                        ...
                                        coroutineScope.launch(Dispatchers.IO) {
                                            try {
                                                ...
                                                coroutineScope.launch(Dispatchers.Main) {
                                                    Toast.makeText(context, "An error occurred while saving the document.", Toast.LENGTH_SHORT).show()
                                                }
                                            }
                                        }
                                    }
